...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-black via-purple-900 to-cyan-300" >
      <div className="bg-gradient-to-r from-black via-purple-900 to-cyan-300"></div>
      <nav className="w-full flex md:justify-left justify-between items-center p-4">
        ...
        <ul className="text-white md:flex hidden list-none flex-row justify-between items-center flex-initial">
          ...
          <li className="bg-[#6366f1] py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#da7899] ">
