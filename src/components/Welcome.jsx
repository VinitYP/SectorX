...
const Welcome = () => {
  ...
  const { connectWallet,currentAccount, fromData,sendTransaction, handleChange, isLoading  } = useContext(TransactionContext);
  ...
  const handleSubmit = (e) => {
    ...
    return (
      ...
      <div class="flex w-full justify-center items-center">
        <div class="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
          <div class="flex flex-1 justify-start flex-col md:mr-10">
            <h1 class="text-3xl sm:text-5xl text-white py-1">
            ...
            {!currentAccount && (
              <button type="button"
                      ...
                      class="flex flex-row justify-center items-center my-5 bg-blue-900 p-3 rounded-full cursor-pointer hover:bg-blue-800">
              <p class="text-white text-base">Connect Wallet</p>
              </button>
           ...
           <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
            ...
            <div className="p-5 sm:w-96 w-full flex-col text-white justify-start items-center blue-glassmorphism">
